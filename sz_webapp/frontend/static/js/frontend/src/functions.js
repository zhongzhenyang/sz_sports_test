...
var functions=(function(config){
    ...
    return {
        ...
        getPathParams:function(url){
            var pos=url.indexOf("?");
            var paramsString=url.substring(pos+1);
            ...
            for(var i= 0,len=params.length;i<len;i++){
                paramArray=params[i].split("=");
                paramObj[paramArray[0]]=paramArray[1];
            }
        ...
        ajaxReturnErrorHandler:function(errorCode){
            ...
            switch(errorCode){
                ...
                case "50014":
                    ...
                    break;
                case "50017":
                    message=config.messages.teamIsSame;
                    break;
                case "60001":
                    message=config.messages.venueNotExist;
                    break;
                case "70002":
                    message=config.messages.hasTeamMessageNotHandle;
                    break;
                case "80003":
